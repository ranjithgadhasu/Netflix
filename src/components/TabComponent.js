...
// Tabs Content
import TabContenetTwo from "./TabContentTwo";
      ...
      <Tabs className="tabs" selectedIndex={this.state.tabIndex} onSelect={tabIndex => this.setState({ tabIndex })}>
       <TabList className="tab-nav-container">
          ...
          <Tab className={`${this.state.tabIndex === 1 ? 'tab-selected active' : null}`}>
            <TabDevices/>
            <p className='lgScreen' style={{ marginTop: '-5.3125rem' }}></p>
            <p><strong>Watch anywhere</strong></p>
            <span className='mdScreen' style={{ marginTop: '-8.3125rem' }}>
              Devices
            </span>
            </Tab>
          <Tab className={`${this.state.tabIndex === 2 ? 'tab-selected active' : null}`}>
            ...
            <br />
            <span className='mdScreen' style={{ marginTop: '7px' }}>
              Price
            </span>
          </Tab>
        </TabList> 
